...
description: Control computers and web interfaces with visual agent capabilities for element localization and reasoning
---
...
[View on GitHub](https://github.com/QwenLM/Qwen3-VL/blob/main/cookbooks/computer_use.ipynb)
